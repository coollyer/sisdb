#ifndef _sisdb_rmsn_h
#define _sisdb_rmsn_h
...
typedef struct s_sisdb_rmsn_cxt
{
    int                status;         // 工作状态
    ...
    int                submode;        // 0 SIS_MAP_SUB_TSNO 1 SIS_MAP_SUB_DATA
...
bool sisdb_rmsn_init(void *, void *);
void sisdb_rmsn_uninit(void *);
void sisdb_rmsn_working(void *);
