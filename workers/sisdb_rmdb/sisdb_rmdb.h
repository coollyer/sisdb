#ifndef _sisdb_rmdb_h
#define _sisdb_rmdb_h
...
typedef struct s_sisdb_rmdb_cxt
{
    int                status;         // 工作状态
...
bool sisdb_rmdb_init(void *, void *);
void sisdb_rmdb_uninit(void *);
void sisdb_rmdb_working(void *);
